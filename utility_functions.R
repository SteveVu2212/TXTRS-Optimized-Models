...
est_geo_return <- function(mean_return, sd_return){
  geo_return_ <- mean_return - sd_return^2/(2*(1+mean_return)) 
  return(geo_return_)
}
...
expected_icr <- function(geometric_return, sd_return, smooth_period, floor, cap,
                         upside_share, n_periods = 30, n_simulations = 10000) {
  #convert the geometric return into arithmetic return
  ...
  #calculate smooth returns for each column of the matrix. Note that rollapply acts on each column of a matrix by default.
...
expected_icr_rcpp <- function(geometric_return, sd_return, smooth_period, floor, cap,
                         upside_share, n_periods = 30, n_simulations = 10000) {
  #convert the geometric return into arithmetic return
  mean_return <- est_arith_return(geometric_return, sd_return)
  #simulate returns with the arithmetic avg return and standard deviation
